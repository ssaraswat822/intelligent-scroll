...
const ARTICLE = [
  ...
  "Lanternfish carry photophores whose arrangement differs between the sexes.",
  "Certain brittle stars flash along an arm that has already been detached.",
  "Luminous bacteria colonise decaying material and were once called grave lights.",
  "Sailors recorded glowing wakes long before any chemical account existed.",
  "Cypridina extract retained its activity after drying and was used in wartime.",
  "Coelenterazine serves as the substrate across a wide range of marine taxa.",
